...
link:{SpreadsheetLink}.{SpreadsheetName}{ApiProp}validationinputmessageposition.html[ValidationInputMessagePosition] プロパティを使用すると、アクティブ セルと関連付けられた入力メッセージの位置を設定できます。 
