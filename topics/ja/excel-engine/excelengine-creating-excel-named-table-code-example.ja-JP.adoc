...
|metadata|
{
    ...
    "tags": [],
    "guid": "164bc99e-a9e8-4984-ade9-f91518811980","buildFlags": [],
    ...
    Public Class ExcelExampleTable
        Public Shared Function CreateExampleWorkbook() As Workbook
            ...
            For Each patient As Patient In patients
                ...
                worksheetRow.Cells(System.Threading.Interlocked.Increment(currentCell)).Value = DateTime.Parse(patient.DOB.Topick:[win-forms,asp-net,win-forms-old,aspnet-old,wpf="ShortDate"]String())
                worksheetRow.Cells(System.Threading.Interlocked.Increment(currentCell)).Value = Integer.Parse(patient.DOB.Year.ToString())
                worksheetRow.Cells(System.Threading.Interlocked.Increment(currentCell)).Value = DateTime.Parse(patient.AcceptanceDate.Topick:[win-forms,asp-net,win-forms-old,aspnet-old,wpf="ShortDate"]String())
    ...
    public class ExcelExampleTable
    {
        public static Workbook CreateExampleWorkbook()
        {
            ...
            foreach (Patient patient in patients)
            {
                ...
                worksheetRow.Cells[++currentCell].Value = DateTime.Parse(patient.DOB.Topick:[win-forms,asp-net,win-forms-old,aspnet-old,wpf="ShortDate"]String());
                worksheetRow.Cells[++currentCell].Value = int.Parse(patient.DOB.Year.ToString());
                worksheetRow.Cells[++currentCell].Value = DateTime.Parse(patient.AcceptanceDate.Topick:[win-forms,asp-net,win-forms-old,aspnet-old,wpf="ShortDate"]String());
