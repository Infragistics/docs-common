...
* link:{BarcodesLink}.{BarcodePDF417Name}{ApiProp}rows.html[Rows]
* link:{BarcodesLink}.{BarcodePDF417Name}{ApiProp}columns.html[Columns]
* link:{BarcodesLink}.{BarcodePDF417Name}{ApiProp}errorcorrectionlevel.html[ErrorCorrectionLevel]
* link:{BarcodesLink}.{BarcodePDF417Name}{ApiProp}aspectratio.html[AspectRatio]
* link:{BarcodesLink}.{BarcodePDF417Name}{ApiProp}useminimumerrorcorrectionlevel.html[UseMinimumErrorCorrectionLevel]
* link:{BarcodesLink}.{BarcodePDF417Name}{ApiProp}encodingmode.html[EncodingMode]
