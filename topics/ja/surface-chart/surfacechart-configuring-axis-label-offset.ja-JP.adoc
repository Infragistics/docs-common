...
このトピックは、 link:{SurfaceChartLink}.xamscattersurface3d_members.html[xamScatterSurface3D] コントロールで軸からのラベル オフセットを構成する方法を説明します。
...
* <<_Ref443326858, 軸ラベル オフセットの構成 >>
* <<_Ref443497478, 関連コンテンツ >>
...
link:{SurfaceChartLink}.surfacechartaxis.html[SurfaceChartAxis] link:{SurfaceChartLink}.surfacechartaxis~labeloffset.html[LabelOffset] プロパティを使用してその軸からのラベル オフセットを設定します。
