...
|Axis
| link:{SparklineLink}.{SparklineName}~horizontalaxisvisibility.html[HorizontalAxisVisibility] link:{SparklineLink}.{SparklineName}~verticalaxisvisibility.html[VerticalAxisVisibility]
...
The Trend Line feature enables you to choose among several formulas for generating a trending directional line. The formula to use is specified in the link:{SparklineLink}.{SparklineName}~trendlinetype.html[TrendLineType] property. The Trend Line renders in front of the series data so it is always visible.
...
The visibility of the X and Y axis are managed by separate properties ( link:{SparklineLink}.{SparklineName}~horizontalaxisvisibility.html[HorizontalAxisVisibility] and link:{SparklineLink}.{SparklineName}~verticalaxisvisibility.html[VerticalAxisVisibility], respectively) so it is possible to have only one of them displayed.
