...
ifdef::win-forms[] 
link:{SparklineLink}.{SparklineName}{ApiProp}datasource.html[DataSource] 
endif::win-forms[]
property which is used to bind the control to an instance of the data collection and the link:{SparklineLink}.{SparklineName}{ApiProp}valuememberpath.html[ValueMemberPath] property to identify what data to should be displayed.
