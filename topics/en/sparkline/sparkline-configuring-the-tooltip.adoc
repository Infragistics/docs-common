...
This topic explains, with code examples, how to configure and customize a tooltip in a link:{ApiPlatform}controls.charts.{SparklineName}{ApiVersion}.html[{SparklineName}]™.
...
| link:sparkline-adding-a-tooltip.html[Adding a Tooltip] 

|This topic explains, with code examples, how to add a tooltip in _{SparklineName}_ control. 
...
There are two ways to customize the tooltip, depending on what the link:{SparklineLink}.{SparklineName}{ApiProp}tooltip.html[ToolTip] property is set to display:

* String – By setting the link:{SparklineLink}.{SparklineName}{ApiProp}tooltip.html[ToolTip] property to a string such as:

`ToolTip="Testing the Tooltip"`

* Data Template – when the link:{SparklineLink}.{SparklineName}{ApiProp}tooltip.html[ToolTip] property is set to a `DataTemplate`, the `DataContext` object of that DataTemplate is set to a link:{ApiPlatform}controls.charts.{SparklineName}{ApiVersion}~infragistics.controls.charts.sparklinetooltipcontext.html[SparklineTooltipContext], which exposes four properties that can be customized in the DataTemplate, those properties are link:{ApiPlatform}controls.charts.{SparklineName}{ApiVersion}~infragistics.controls.charts.sparklinetooltipcontext~first.html[First], link:{ApiPlatform}controls.charts.{SparklineName}{ApiVersion}~infragistics.controls.charts.sparklinetooltipcontext~last.html[Last], link:{ApiPlatform}controls.charts.{SparklineName}{ApiVersion}~infragistics.controls.charts.sparklinetooltipcontext~high.html[High], and link:{ApiPlatform}controls.charts.{SparklineName}{ApiVersion}~infragistics.controls.charts.sparklinetooltipcontext~low.html[Low].
...
| link:{SparklineLink}.{SparklineName}{ApiProp}tooltip.html[ToolTip]
...
In the following code, a data template uses all available properties in the link:{ApiPlatform}controls.charts.{SparklineName}{ApiVersion}~infragistics.controls.charts.sparklinetooltipcontext.html[SparklineToolTipContext] object ( link:{ApiPlatform}controls.charts.{SparklineName}{ApiVersion}~infragistics.controls.charts.sparklinetooltipcontext~first.html[First], link:{ApiPlatform}controls.charts.{SparklineName}{ApiVersion}~infragistics.controls.charts.sparklinetooltipcontext~last.html[Last], link:{ApiPlatform}controls.charts.{SparklineName}{ApiVersion}~infragistics.controls.charts.sparklinetooltipcontext~high.html[High] and link:{ApiPlatform}controls.charts.{SparklineName}{ApiVersion}~infragistics.controls.charts.sparklinetooltipcontext~low.html[Low]) to achieve the following customized look:
