...
The tooltip is added by setting the link:{SparklineLink}.{SparklineName}{ApiProp}tooltipvisibility.html[ToolTipVisibility] property. If this property is set to visible, the tooltip displays the following default values:
