...
image:images\Xamarin_XamLinearGaugeScreenShot.png[alt="{LinearGaugeName} Configurator"]

endif::xamarin[]

ifdef::wpf[]

image:images\WPF_ConfiguratorLinearGaugeScreenShot.png[alt="{LinearGaugeName} Configurator"]
...
Get the most from the {LinearGaugeName} Configurator by viewing these link:https://www.youtube.com/playlist?list=PLZ4rRHIJepBu9ge71Sn7dcL6vSdsh4T0z[videos].
