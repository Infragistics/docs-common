...
The Radial Gauge Control Configurator is a visual tool that enables the developer to very quickly visually configure an Infragistics {PlatformName} {RadialGaugeName} control with a real-time preview of the control as it is being configured. The Preview is close to how it will appear at runtime on the mobile device.
...
Get the most from the {RadialGaugeName} Configurator by viewing these link:https://www.youtube.com/playlist?list=PLZ4rRHIJepBu9ge71Sn7dcL6vSdsh4T0z[videos].
