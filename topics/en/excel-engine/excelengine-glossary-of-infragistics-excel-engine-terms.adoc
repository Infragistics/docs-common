...
= Glossary of Terms ({ExcelEngineName})
...
| link:excelengine-reference-cells-and-regions.html[Reference Cells and Regions (Infragistics Excel Engine)]
|Demonstrates how to access a cell and a region by a string reference.

| link:excelengine-accessing-cells-and-cell-regions.html[Accessing Cells and Cell Regions by Name (Infragistics Excel Engine)]
