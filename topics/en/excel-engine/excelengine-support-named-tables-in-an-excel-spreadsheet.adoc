...
= Supporting Named Tables in a Worksheet pick:[wpf,xamarin="({ExcelEngineName})"]

== Topic Overview

=== Purpose

This topic describes table support in {ExcelEngineName}.
...
The following table summarizes the main features of the table support of {ExcelEngineName}. Additional details are available after the summary table.
