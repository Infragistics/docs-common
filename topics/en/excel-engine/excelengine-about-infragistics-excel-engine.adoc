...
= About {ExcelEngineName}

Using the {ExcelEngineName} allows you to work with spreadsheet data using familiar Microsoft® Excel® spreadsheet objects like link:{ExcelEngineApiLink}infragistics.documents.excel.workbook.html[Workbooks], link:{ExcelEngineApiLink}infragistics.documents.excel.worksheet.html[Worksheets], link:{ExcelEngineApiLink}infragistics.documents.excel.worksheetcell.html[Cells], link:{ExcelEngineApiLink}infragistics.documents.excel.formula.html[Formulas] and many more. The {ExcelEngineName} makes it easy for you to represent the data of your application in an Excel spreadsheet as well as transfer data from Excel into your application.
...
The following is a list of key features of the {ExcelEngineName}:

* *No Excel Dependency* - The {ExcelEngineName} is a class library that runs completely independently of Microsoft Excel, so you do not require it to be installed.
...
link:excelengine-list-of-supported-built-in-functions.html[List of Supported Built-in Functions ({ExcelEngineName})]

link:excelengine-glossary-of-infragistics-excel-engine-terms.html[Glossary of Terms ({ExcelEngineName})]
