...
= Preserving Table Formatting When Loading Excel Files pick:[wpf,xamarin="({ExcelEngineName})"]
...
ifdef::xamarin[]
* An input stream to a Microsoft Excel file.
endif::xamarin[]
