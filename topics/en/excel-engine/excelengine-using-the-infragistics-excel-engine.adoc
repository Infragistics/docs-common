...
|metadata|
{
    ...
    "tags": [],
    "guid": "{A271E23A-6CD7-43B0-821F-E7D85B2C7030}","buildFlags": [],
    "createdOn": "2008-05-02T15:46:57Z"
}
|metadata|
////

= Using the {ExcelEngineName}
...
* link:excelengine-adding-a-chart-to-an-excel-worksheet.html[Adding a Chart to a Worksheet]
* link:excelengine-adding-a-sparkline-to-an-excel-worksheet.html[Adding a Sparkline to a Worksheet]
...
* link:excelengine-filtering-worksheet-regions.html[Filtering Worksheet Regions]
...
These groups of topics contain important task-based information that will help you to effectively use the various features and functionalities provided by the {ExcelEngineName}.
...
| link:excelengine-workbookoperations.html[Workbook Operations ({ExcelEngineName})]
|The topics in this group explain workbook-related operations.

| link:excelengine-worksheetoperations.html[Worksheet Operations ({ExcelEngineName})]
|The topics in this group explain worksheet-related operations.

| link:excelengine-workingwithcells.html[Working with Cells ({ExcelEngineName})]
|The topics in this group explain cell-related operations.

|link:excelengine-workingwithcharts.html[Working with Charts ({ExcelEngineName})]
|The topics in this group explain operations with different kinds of charts.

| link:excelengine-workingwithobjects.html[Working with Objects ({ExcelEngineName})]
|The topics in this group explain operations with different kind of objects, like images, hyperlinks and shapes.

| link:excelengine-workingwithtables.html[Working with Tables ({ExcelEngineName})]
