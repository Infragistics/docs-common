...
pick:[win-forms,sl,win-phone,win-universal,wpf="*In Visual Basic:*"]
...
pick:[win-forms,sl,win-phone,win-universal,wpf,xamarin="*In C#:*"]
...
pick:[sl,win-phone,win-universal,wpf,xamarin="*In XAML:*"]
...
ifdef::win-forms,sl,wpf,win-universal[]
|
| pick:[win-forms,sl,wpf,win-universal=" link:{FunnelChartLink}.{FunnelChartName}{ApiProp}innerlabelvisibility.html[InnerLabelVisibility]"] 
|Visible
endif::win-forms,sl,wpf,win-universal[]

ifdef::win-forms,sl,wpf,win-universal[]
|
| pick:[win-forms,sl,wpf,win-universal=" link:{FunnelChartLink}.{FunnelChartName}{ApiProp}outerlabelvisibility.html[OuterLabelVisibility]"] 
|Visible
endif::win-forms,sl,wpf,win-universal[]
