...
[NOTE]
====
For disabling editing of a worksheet refer to the link:excelengine-disable-editing-of-a-worksheet.html[Disabling Editing of a Worksheet (Infragistics Excel Engine)] topic.
====
endif::xaml[]
