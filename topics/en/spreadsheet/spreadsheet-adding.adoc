...
Create a workbook, naming it "wb1" and add content in it as described in the  pick:[xaml=" link:excelengine-creating-a-workbook.html[Creating a Workbook (Infragistics Excel Engine)]"]  pick:[win-forms=" link:excelengine-create-a-workbook.html[Creating a Workbook (Infragistics Excel Engine)]"]  topic.
...
Set the {SpreadsheetName}’s   link:{SpreadsheetLink}.{SpreadsheetName}{ApiProp}workbook.html[Workbook] property to the workbook create in the step 4 or 5.
