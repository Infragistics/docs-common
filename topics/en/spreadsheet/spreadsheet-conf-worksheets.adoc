...
[NOTE]
====
If you need to configure these aspects individually for each worksheet please look at the Excel Engine's link:excelengine-worksheetoperations.html[Worksheet Operations] section.
====
endif::xaml[] 
...
ifdef::xaml[]
|pick:[xaml=" link:excelengine-workbook-protection.html[Workbook Protection (Infragistics Excel Engine)]"]
