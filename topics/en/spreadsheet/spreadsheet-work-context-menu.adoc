...
[start=1]
. Create an instance of link:{ApiPlatform}controls.grids.xamspreadsheet{ApiVersion}~infragistics.controls.grids.spreadsheetcontextmenuprovider_members.html[SpreadsheetContextMenuProvider] and set it to the link:{SpreadsheetLink}.{SpreadsheetName}{ApiProp}contextmenuprovider.html[ContextMenuProvider] property of the {SpreadsheetName}.
[start=2]
