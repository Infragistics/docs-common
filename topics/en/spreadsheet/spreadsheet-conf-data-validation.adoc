...
You can set the position of the input message associated with the active cell using the link:{SpreadsheetLink}.{SpreadsheetName}{ApiProp}validationinputmessageposition.html[ValidationInputMessagePosition] property. 
