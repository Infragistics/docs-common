...
= Working with the {SpreadsheetName}
...
| link:spreadsheet-uiu-custom-filter-dialog.html[Filter Dialog Interactions ({SpreadsheetName})]
|This topic explains how to prompt the user with a dialog to filter row data in Excel Worksheets for either regions or tables.

| link:spreadsheet-uiu-custom-sort-dialog.html[Sorting Dialog Interactions ({SpreadsheetName})]
|This topic explains how to prompt the user with a dialog to sort column or row data in Excel Worksheets, filter regions and tables.

| link:spreadsheet-format-cells-dialog.html[Working with Format cell Dialog ({SpreadsheetName})]
