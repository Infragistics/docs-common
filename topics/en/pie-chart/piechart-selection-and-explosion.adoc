...
The {PieChartName} control supports explosion of individual pie slices as well as a link:{PieChartLink}.{PieChartBase}~sliceclick_ev.html[SliceClick] event that allows you to modify selection states and implement custom logic.
