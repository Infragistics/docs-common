...
|metadata|
{
    ...
    "tags": [],
    "guid": "5f6c1c5a-af05-4af3-af4b-5c09f71531fb","buildFlags": ["wpf"],
...
* Create a {PlatformName} project and add the following NuGet package reference: 
...
* <<_Ref444183101, **Set the ItemsSource for the Surface Chart**>> 
* <<_Ref444183122, **Set the Member Path Properties on the Surface Chart **>> 
* <<_Ref444530102, **Set the Axes Properties (optional)**>>
...
[[_Ref444183101]]
==== Set the ItemsSource for the Surface Chart 
...
[[_Ref444183122]]
==== Set the Member Path properties on the Surface Chart 

In this particular code example, the data model has three properties – X, Y and Z that hold coordinate data that should be plotted. The XMemberPath, YMemberPath, and ZMemberPath properties create mappings between data model members and Axis coordinates.
...
[[_Ref444530102]]
==== Set the Axes Properties (optional)

Create 3 instances of LinearAxis objects and assign them to the XAxis, YAxis, and ZAxis properties of the Surface Chart:
