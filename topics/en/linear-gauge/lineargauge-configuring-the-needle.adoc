...
* <<_Ref362941112,Configuring the Needle – Conceptual Overview>>
...
* <<_Ref362941136,Configuring the Needle Shape>>

** <<_Needle_shape_configuration,Needle shape configuration summary>>
** <<_Ref369722614,Property subsets per part>>
...
The following screenshot demonstrates how the _{LinearGaugeName}_ control with the highlight needle enabled looks as a result of the following settings:
