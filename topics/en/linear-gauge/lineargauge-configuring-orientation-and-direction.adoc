...
|This is a group of topics covering in detail the visual elements of the _{LinearGaugeName}_ control (like the scale elements, performance bar, comparative marker and ranges, etc.) and explaining, with code examples, how to configure them.
