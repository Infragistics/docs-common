...
|The link:{DataChartLink}.DataToolTipLayer.html[DataToolTipLayer] displays a visualization much like the link:datachart-data-legend.md[{DataLegendName}] as you mouse over the different series of the chart.
