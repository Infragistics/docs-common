...
The world navigation system consists of properties for setting position and size of the link:{GeoMapLink}.{GeoMapName}~worldrect.html[WorldRect] – a map view in geographic coordinates. In this navigation system values can be set between -180 and 180 for longitude properties of the link:{GeoMapLink}.{GeoMapName}~worldrect.html[WorldRect] and values between -85 and 85 for latitude properties of the link:{GeoMapLink}.{GeoMapName}~worldrect.html[WorldRect] view.

The following image is a preview of _{GeoMapName}_ control with highlighted position and size of the link:{GeoMapLink}.{GeoMapName}~worldrect.html[WorldRect] when zoomed to some region of the map content (for example, Africa and Europe continents).
